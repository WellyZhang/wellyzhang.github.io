...
> This post briefly summarizes our work on the ALgebra-Aware Neuro-Semi-Symbolic (ALANS) learner for Raven's Progressive Matrices (RPM). For further details, please refer to our ECCV 2022 [paper](https://drive.google.com/file/d/1KLvi_p1g3FRehAe9j2_rmXRux-uciQnZ/view?usp=sharing). It is a follow-up work of PrAE in the CVPR 2021 [paper](https://drive.google.com/file/d/1tlKHSYwuxxIvr8fyy_SPbx6QExoqMy-B/view?usp=sharing): ALANS relaxes the requirement of knowledge in PrAE, and adopts on-the-fly optimization to perform induction instead of abduction. 
...
Apart from being superior in systematic generalization, ALANS is also performant on the in-distribution setup. Besides, the model learns to "see" and "reason" during the training process. Please refer to our [paper](https://drive.google.com/file/d/1KLvi_p1g3FRehAe9j2_rmXRux-uciQnZ/view?usp=sharing) for detailed explanation. 
