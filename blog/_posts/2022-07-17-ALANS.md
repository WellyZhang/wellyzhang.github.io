...
<small class="img-hint">Table 1. Model performance on different aspects of systematic generalization. The performance is measured by accuracy on the test sets. Upper half: results on datasets generated by the RAVEN method. Lower hal: results on datasets generated by the I-RAVEN method.</small>
...
@inproceedings{zhang2022learning,
    ...
    booktitle={To appear in Proceedings of the European Conference on Computer Vision (ECCV)},
    year={2022}
}
```
