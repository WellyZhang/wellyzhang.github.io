...
> This post briefly summarizes our work on the Probabilistic Abduction and Execution (PrAE) learner for Raven's Progressive Matrices (RPM). For further details, please refer to our CVPR 2021 [paper](https://drive.google.com/file/d/1tlKHSYwuxxIvr8fyy_SPbx6QExoqMy-B/view?usp=sharing).
